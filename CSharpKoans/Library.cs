    ...
    public class Library
    {
        ...
        public Library()
        {
            Books = new List<Book> { 
                ...
                new Book("Lolita, light of my life, fire of my loins."){ Title = "Lolita", Author = "Nabokov", PublicationYear = 1955 },
               new Book("All this happened, more or less."){Title="Slaughterhouse-Five", Author="Vonnegut", PublicationYear=1969},
